...
namespace SumOfMultiplesOfThreeDoWhileVersion
{
    class Program
    {
        /* The following code is The Sum of Multiples of Three - Do While Version
         * COURSE COMP100
        ...
        {
            WriteLine("It shows the sum of multiples of three - do while version.");
            WriteLine("Written by: Lipe Teixeira");
            WriteLine();
            WriteLine("Let's show the sum of multiples of three - do while version:");
            WriteLine();
